...
public class DSSUVerInscripciones extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DSSUVerInscripciones frame = new DSSUVerInscripciones();
	...
	public DSSUVerInscripciones() {
		...
		JLabel lblNewLabel = new JLabel("INSCRIPCIONES");
